        ...
        <div>
            ...
            <div className="w-full lg:px-16 px-4 my-8">
                <div className="flex gap-8 items-center justify-between">
                    ...
                    <p className=" text-primary lg:flex hidden">Don’t have an account?</p>
                    <a href="/register"><button className=" border lg:flex hidden border-[#EB5E28] px-4 py-2 text-[#EB5E28] rounded-md">Sign Up</button></a>
                    </div>
                ...
                <p className="text-primary mb-2 text-center">Don’t have an account?</p>
                <a href="/register"><button className="border w-full border-[#EB5E28] px-4 py-2 text-[#EB5E28] rounded-md">Sign Up</button></a>
            </div>
            </div>
            <Outlet />
        </div>
